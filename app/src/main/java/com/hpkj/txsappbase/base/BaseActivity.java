package com.hpkj.txsappbase.base;
...
import com.hpkj.txsappbase.action.ActivityAction;
import com.hpkj.txsappbase.action.BundleAction;
import com.hpkj.txsappbase.action.ClickAction;
import com.hpkj.txsappbase.action.HandlerAction;
import com.hpkj.txsappbase.action.KeyboardAction;
...
public abstract class BaseActivity<T> extends AppCompatActivity implements ActivityAction, ClickAction,
    ...
    protected void initLayout() {
        if (getContentViewId() > 0 ) {
            binding = (T) DataBindingUtil.setContentView(this,getContentViewId());
